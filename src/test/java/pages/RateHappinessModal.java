...
public class RateHappinessModal extends BaseModal {
    ...
    public RateHappinessModal updateMood(String moodRatingText) {
        $(sliderCss).click();
        int moodRating = Integer.parseInt(moodRatingText);
        int currentMountCount = 5;
        int difference = moodRating - currentMountCount;
        Keys arrowValue;
        if (difference>0){
